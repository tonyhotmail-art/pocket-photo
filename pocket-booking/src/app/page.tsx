            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-md-4 text-center text-md-end text-white">
                        <!--/*** This template is free as long as you keep the below author? credit link/attribution link/backlink. ***/-->
                        <!--/*** If you'd like to use the template without the below author? credit link/attribution link/backlink, ***/-->
